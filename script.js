$(document).ready(function() {
    if ("geolocation" in navigator) {
        $('#logButton').click(function() {
            ...
            $('#locationData').html('<div class="loader"></div>');
            ...
            navigator.geolocation.getCurrentPosition(function(position) {
                ...
                // Show loading spinner while sending data to ThingSpeak
                $('#thingSpeakData').html('<div class="loader"></div>');
...
function sendDataToThingSpeak(latitude, longitude) {
    var apiUrl = "https://api.thingspeak.com/update?api_key=5B84T2DZ16FT0RDC&field1=" + latitude + "&field2=" + longitude;
...
function fetchThingSpeakData() {
    var apiUrl = "https://api.thingspeak.com/channels/2517667/feeds.json?api_key=W400HJTWWJAI5AOI&results=1";
...
function displayThingSpeakChart() {
    var iframe = '<iframe width="450" height="260" style="border: 1px solid #cccccc;" src="https://thingspeak.com/channels/2531617/charts/1?bgcolor=%23ffffff&color=%23d62020&dynamic=true&results=60&type=line&update=15"></iframe>    ';
